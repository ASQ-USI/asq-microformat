...
(function(){
  ...
  this.parse = function(html, options, callback){
    ...
    var errors = self.errors.length === 0 // Set errors to null if there are
      ? null                              // no errors.
      : self.errors;
    return returnData(errors, data, callback, deferred, logger, start);
